...
* \*\*\*\*[**macOS Install Mojave.app**](https://drive.google.com/open?id=1fp7cBfkWZcyCnt0gy6zIxf6uN_nD-v1G)**\(10.14.1 18B75\) or** [**macOS Install High Sierra.app**](https://drive.google.com/file/d/17U2GMCfIbLPN8SOfGoKl40vuIDZp3rt7/view)**\(10.13.6 17G65\).** \(Read the Requirements part below to know which version of macOS is compatible. Download this only if you are making Offline Installer.\)
* **AMD USERS,** please note that only the versions of macOS Installer that is listed on [the vanilla patches github page](https://github.com/AMD-OSX/AMD_Vanilla) will work. \(Go to [this page](version-number.md) to know how to check the version number of your installer.\)
